...
export const MANUAL_LEVELS: Level[] = [
  {
    ...
    solutions: {
      ...
      "#FFCC00": [{ x: 3, y: 1 }, { x: 3, y: 2 }, { x: 2, y: 2 }],
  ...
  },
  {
    ...
    solutions: {
      "#FF3B30": [{ x: 0, y: 0 }, { x: 0, y: 1 }, { x: 0, y: 2 }, { x: 0, y: 3 }, { x: 0, y: 4 }, { x: 1, y: 4 }],
...
solutions: {
  "#FF3B30": [{ x: 5, y: 2 }, { x: 5, y: 0 }],
  "#007AFF": [{ x: 1, y: 5 }, { x: 0, y: 4 }],
  "#34C759": [{ x: 5, y: 5 }, { x: 1, y: 4 }],
  "#FFCC00": [{ x: 2, y: 1 }, { x: 4, y: 4 }],
  "#AF52DE": [{ x: 1, y: 1 }, { x: 4, y: 5 }]
}
},
{
id: 4,
...
solutions: {
  "#FF3B30": [{ x: 1, y: 3 }, { x: 5, y: 4 }],
  "#007AFF": [{ x: 5, y: 3 }, { x: 4, y: 1 }],
  "#34C759": [{ x: 1, y: 0 }, { x: 5, y: 2 }],
  "#FFCC00": [{ x: 5, y: 5 }, { x: 3, y: 5 }],
  "#AF52DE": [{ x: 3, y: 3 }, { x: 2, y: 5 }],
  "#FF9500": [{ x: 3, y: 2 }, { x: 0, y: 0 }]
}
},
  {
  id: 5,
...
solutions: {
  "#FF3B30": [{ x: 0, y: 2 }, { x: 5, y: 0 }],
  "#007AFF": [{ x: 1, y: 3 }, { x: 3, y: 4 }],
  "#34C759": [{ x: 1, y: 4 }, { x: 4, y: 6 }],
  "#FFCC00": [{ x: 1, y: 1 }, { x: 6, y: 2 }],
  "#AF52DE": [{ x: 4, y: 0 }, { x: 0, y: 1 }],
  "#FF9500": [{ x: 1, y: 2 }, { x: 5, y: 6 }],
  "#5AC8FA": [{ x: 4, y: 2 }, { x: 6, y: 6 }],
  "#FF2D55": [{ x: 2, y: 5 }, { x: 4, y: 5 }]
}
},
{
id: 97,
...
solutions: {
  "#FF3B30": [{ x: 0, y: 0 }, { x: 3, y: 2 }],
  "#007AFF": [{ x: 3, y: 0 }, { x: 0, y: 1 }],
  "#34C759": [{ x: 6, y: 6 }, { x: 3, y: 6 }],
  "#FFCC00": [{ x: 0, y: 2 }, { x: 0, y: 6 }],
  "#AF52DE": [{ x: 4, y: 0 }, { x: 0, y: 7 }],
  "#FF9500": [{ x: 1, y: 5 }, { x: 5, y: 1 }],
  "#5AC8FA": [{ x: 6, y: 1 }, { x: 1, y: 6 }]
}
},
{
id: 98,
...
solutions: {
  "#FF3B30": [{ x: 0, y: 0 }, { x: 0, y: 6 }],
  "#007AFF": [{ x: 0, y: 7 }, { x: 1, y: 6 }],
  "#34C759": [{ x: 2, y: 6 }, { x: 4, y: 7 }],
  "#FFCC00": [{ x: 1, y: 5 }, { x: 6, y: 7 }],
  "#AF52DE": [{ x: 1, y: 0 }, { x: 4, y: 5 }],
  "#FF9500": [{ x: 3, y: 1 }, { x: 6, y: 4 }],
  "#5AC8FA": [{ x: 6, y: 6 }, { x: 3, y: 2 }],
  "#FF2D55": [{ x: 4, y: 3 }, { x: 7, y: 7 }]
}
},
{
id: 99,
...
pairs: [
  ...
  { color: "#007AFF", start: { x: 1, y: 1 }, end: { x: 0, y: 7 } },
  { color: "#34C759", start: { x: 4, y: 7 }, end: { x: 7, y: 7 } },
  { color: "#FFCC00", start: { x: 2, y: 0 }, end: { x: 0, y: 5 } },
  { color: "#AF52DE", start: { x: 2, y: 2 }, end: { x: 1, y: 7 } },
  { color: "#FF9500", start: { x: 3, y: 2 }, end: { x: 3, y: 5 } },
  { color: "#5AC8FA", start: { x: 4, y: 3 }, end: { x: 2, y: 5 } }
],
solutions: {
  "#FF3B30": [{ x: 4, y: 5 }, { x: 4, y: 1 }],
  "#007AFF": [{ x: 1, y: 1 }, { x: 0, y: 7 }],
  "#34C759": [{ x: 4, y: 7 }, { x: 7, y: 7 }],
  "#FFCC00": [{ x: 2, y: 0 }, { x: 0, y: 5 }],
  "#AF52DE": [{ x: 2, y: 2 }, { x: 1, y: 7 }],
  "#FF9500": [{ x: 3, y: 2 }, { x: 3, y: 5 }],
  "#5AC8FA": [{ x: 4, y: 3 }, { x: 2, y: 5 }]
}
},
{
id: 100,
...
solutions: {
  "#FF3B30": [{ x: 7, y: 0 }, { x: 4, y: 0 }],
  "#007AFF": [{ x: 0, y: 0 }, { x: 2, y: 1 }],
  "#34C759": [{ x: 1, y: 0 }, { x: 2, y: 7 }],
  "#FFCC00": [{ x: 0, y: 6 }, { x: 5, y: 5 }],
  "#AF52DE": [{ x: 4, y: 2 }, { x: 0, y: 7 }],
  "#FF9500": [{ x: 4, y: 5 }, { x: 2, y: 4 }],
  "#5AC8FA": [{ x: 3, y: 5 }, { x: 2, y: 3 }]
}
},
{
id: 101,
...
solutions: {
  "#FF3B30": [{ x: 6, y: 1 }, { x: 2, y: 2 }],
  "#007AFF": [{ x: 0, y: 1 }, { x: 5, y: 7 }],
  "#34C759": [{ x: 1, y: 4 }, { x: 2, y: 6 }],
  "#FFCC00": [{ x: 6, y: 3 }, { x: 0, y: 7 }],
  "#AF52DE": [{ x: 4, y: 4 }, { x: 0, y: 6 }],
  "#FF9500": [{ x: 5, y: 1 }, { x: 0, y: 5 }]
}
},
{
id: 102,
...
solutions: {
  "#FF3B30": [{ x: 2, y: 0 }, { x: 0, y: 2 }],
  "#007AFF": [{ x: 3, y: 5 }, { x: 5, y: 2 }],
  "#34C759": [{ x: 1, y: 4 }, { x: 1, y: 6 }],
  "#FFCC00": [{ x: 6, y: 1 }, { x: 7, y: 7 }],
  "#AF52DE": [{ x: 6, y: 7 }, { x: 7, y: 0 }],
  "#FF9500": [{ x: 7, y: 1 }, { x: 4, y: 5 }],
  "#5AC8FA": [{ x: 5, y: 5 }, { x: 7, y: 3 }]
}
},
{
id: 103,
...
solutions: {
  "#FF3B30": [{ x: 7, y: 7 }, { x: 7, y: 5 }],
  "#007AFF": [{ x: 7, y: 4 }, { x: 4, y: 7 }],
  "#34C759": [{ x: 5, y: 6 }, { x: 5, y: 2 }],
  "#FFCC00": [{ x: 2, y: 5 }, { x: 4, y: 3 }],
  "#AF52DE": [{ x: 4, y: 2 }, { x: 4, y: 4 }],
  "#FF9500": [{ x: 1, y: 3 }, { x: 5, y: 7 }]
}
},
{
id: 104,
...
solutions: {
  "#FF3B30": [{ x: 0, y: 1 }, { x: 7, y: 2 }],
  "#007AFF": [{ x: 1, y: 1 }, { x: 6, y: 2 }],
  "#34C759": [{ x: 0, y: 3 }, { x: 5, y: 2 }],
  "#FFCC00": [{ x: 1, y: 3 }, { x: 6, y: 4 }],
  "#AF52DE": [{ x: 1, y: 4 }, { x: 4, y: 4 }],
  "#FF9500": [{ x: 1, y: 5 }, { x: 2, y: 4 }],
  "#5AC8FA": [{ x: 1, y: 6 }, { x: 6, y: 5 }]
}
},
{
id: 105,
...
solutions: {
  "#FF3B30": [{ x: 6, y: 0 }, { x: 7, y: 2 }],
  "#007AFF": [{ x: 3, y: 0 }, { x: 4, y: 7 }],
  "#34C759": [{ x: 7, y: 0 }, { x: 4, y: 2 }],
  "#FFCC00": [{ x: 7, y: 3 }, { x: 1, y: 6 }],
  "#AF52DE": [{ x: 2, y: 1 }, { x: 6, y: 4 }],
  "#FF9500": [{ x: 6, y: 6 }, { x: 1, y: 1 }]
}
},
{
id: 106,
...
solutions: {
  "#FF3B30": [{ x: 0, y: 0 }, { x: 3, y: 0 }],
  "#007AFF": [{ x: 4, y: 0 }, { x: 7, y: 1 }],
  "#34C759": [{ x: 7, y: 0 }, { x: 6, y: 1 }],
  "#FFCC00": [{ x: 5, y: 0 }, { x: 1, y: 3 }],
  "#AF52DE": [{ x: 1, y: 2 }, { x: 5, y: 3 }],
  "#FF9500": [{ x: 0, y: 6 }, { x: 7, y: 7 }],
  "#5AC8FA": [{ x: 0, y: 5 }, { x: 7, y: 6 }]
}
},
{
id: 107,
...
solutions: {
  "#FF3B30": [{ x: 0, y: 0 }, { x: 2, y: 3 }],
  "#007AFF": [{ x: 2, y: 1 }, { x: 4, y: 5 }],
  "#34C759": [{ x: 5, y: 5 }, { x: 5, y: 1 }],
  "#FFCC00": [{ x: 3, y: 5 }, { x: 6, y: 6 }],
  "#AF52DE": [{ x: 1, y: 6 }, { x: 7, y: 4 }],
  "#FF9500": [{ x: 1, y: 7 }, { x: 1, y: 4 }],
  "#5AC8FA": [{ x: 6, y: 1 }, { x: 2, y: 6 }]
}
},
{
id: 108,
...
solutions: {
  "#FF3B30": [{ x: 0, y: 0 }, { x: 2, y: 0 }],
  "#007AFF": [{ x: 7, y: 4 }, { x: 6, y: 7 }],
  "#34C759": [{ x: 6, y: 1 }, { x: 4, y: 2 }],
  "#FFCC00": [{ x: 3, y: 2 }, { x: 6, y: 6 }],
  "#AF52DE": [{ x: 0, y: 2 }, { x: 5, y: 7 }],
  "#FF9500": [{ x: 3, y: 3 }, { x: 6, y: 2 }],
  "#5AC8FA": [{ x: 3, y: 4 }, { x: 1, y: 2 }],
  "#FF2D55": [{ x: 4, y: 5 }, { x: 0, y: 1 }]
}
},
{
id: 109,
...
pairs: [
  ...
  { color: "#34C759", start: { x: 3, y: 4 }, end: { x: 7, y: 7 } },
  { color: "#FFCC00", start: { x: 6, y: 2 }, end: { x: 3, y: 5 } },
  { color: "#AF52DE", start: { x: 6, y: 1 }, end: { x: 3, y: 6 } }
],
solutions: {
  "#FF3B30": [{ x: 6, y: 4 }, { x: 6, y: 7 }],
  "#007AFF": [{ x: 7, y: 4 }, { x: 3, y: 3 }],
  "#34C759": [{ x: 3, y: 4 }, { x: 7, y: 7 }],
  "#FFCC00": [{ x: 6, y: 2 }, { x: 3, y: 5 }],
  "#AF52DE": [{ x: 6, y: 1 }, { x: 3, y: 6 }]
}
},
{
id: 110,
...
solutions: {
  "#FF3B30": [{ x: 1, y: 0 }, { x: 0, y: 6 }],
  "#007AFF": [{ x: 1, y: 6 }, { x: 1, y: 3 }],
  "#34C759": [{ x: 1, y: 2 }, { x: 0, y: 7 }],
  "#FFCC00": [{ x: 1, y: 1 }, { x: 3, y: 4 }],
  "#AF52DE": [{ x: 6, y: 1 }, { x: 3, y: 6 }],
  "#FF9500": [{ x: 2, y: 0 }, { x: 3, y: 5 }],
  "#5AC8FA": [{ x: 4, y: 6 }, { x: 7, y: 7 }]
}
},
{
id: 111,
...
solutions: {
  "#FF3B30": [{ x: 7, y: 0 }, { x: 5, y: 0 }],
  "#007AFF": [{ x: 1, y: 6 }, { x: 7, y: 1 }],
  "#34C759": [{ x: 2, y: 6 }, { x: 2, y: 3 }],
  "#FFCC00": [{ x: 1, y: 1 }, { x: 4, y: 2 }],
  "#AF52DE": [{ x: 4, y: 0 }, { x: 2, y: 7 }],
  "#FF9500": [{ x: 3, y: 7 }, { x: 7, y: 2 }],
  "#5AC8FA": [{ x: 4, y: 7 }, { x: 4, y: 5 }],
  "#FF2D55": [{ x: 6, y: 2 }, { x: 6, y: 6 }]
}
},
{
id: 112,
...
solutions: {
  "#FF3B30": [{ x: 2, y: 5 }, { x: 2, y: 2 }],
  "#007AFF": [{ x: 3, y: 2 }, { x: 2, y: 7 }],
  "#34C759": [{ x: 7, y: 1 }, { x: 6, y: 2 }],
  "#FFCC00": [{ x: 6, y: 6 }, { x: 5, y: 5 }],
  "#AF52DE": [{ x: 5, y: 6 }, { x: 7, y: 0 }],
  "#FF9500": [{ x: 7, y: 2 }, { x: 3, y: 1 }],
  "#5AC8FA": [{ x: 6, y: 3 }, { x: 4, y: 4 }]
}
},
{
id: 113,
...
solutions: {
  "#FF3B30": [{ x: 7, y: 0 }, { x: 7, y: 3 }],
  "#007AFF": [{ x: 7, y: 7 }, { x: 5, y: 6 }],
  "#34C759": [{ x: 4, y: 7 }, { x: 0, y: 4 }],
  "#FFCC00": [{ x: 0, y: 5 }, { x: 3, y: 6 }],
  "#AF52DE": [{ x: 1, y: 5 }, { x: 2, y: 6 }],
  "#FF9500": [{ x: 6, y: 6 }, { x: 1, y: 1 }],
  "#5AC8FA": [{ x: 1, y: 2 }, { x: 4, y: 3 }],
  "#FF2D55": [{ x: 7, y: 6 }, { x: 4, y: 4 }]
}
},
{
id: 114,
...
solutions: {
  "#FF3B30": [{ x: 7, y: 0 }, { x: 6, y: 1 }],
  "#007AFF": [{ x: 7, y: 2 }, { x: 0, y: 7 }],
  "#34C759": [{ x: 6, y: 0 }, { x: 0, y: 6 }],
  "#FFCC00": [{ x: 7, y: 3 }, { x: 2, y: 2 }],
  "#AF52DE": [{ x: 2, y: 3 }, { x: 5, y: 6 }],
  "#FF9500": [{ x: 5, y: 5 }, { x: 3, y: 5 }],
  "#5AC8FA": [{ x: 7, y: 4 }, { x: 3, y: 6 }],
  "#FF2D55": [{ x: 2, y: 4 }, { x: 3, y: 7 }]
}
},
{
id: 115,
...
solutions: {
  "#FF3B30": [{ x: 7, y: 0 }, { x: 6, y: 6 }],
  "#007AFF": [{ x: 5, y: 4 }, { x: 4, y: 6 }],
  "#34C759": [{ x: 5, y: 6 }, { x: 1, y: 3 }],
  "#FFCC00": [{ x: 1, y: 2 }, { x: 6, y: 2 }],
  "#AF52DE": [{ x: 2, y: 5 }, { x: 6, y: 0 }],
  "#FF9500": [{ x: 1, y: 6 }, { x: 4, y: 3 }],
  "#5AC8FA": [{ x: 3, y: 5 }, { x: 7, y: 7 }]
}
},
{
id: 116,
...
solutions: {
  "#FF3B30": [{ x: 0, y: 0 }, { x: 2, y: 0 }],
  "#007AFF": [{ x: 1, y: 0 }, { x: 1, y: 2 }],
  "#34C759": [{ x: 7, y: 4 }, { x: 0, y: 5 }],
  "#FFCC00": [{ x: 1, y: 5 }, { x: 6, y: 2 }],
  "#AF52DE": [{ x: 1, y: 6 }, { x: 5, y: 2 }],
  "#FF9500": [{ x: 0, y: 4 }, { x: 6, y: 6 }]
}
},
{
id: 117,
...
solutions: {
  "#FF3B30": [{ x: 5, y: 7 }, { x: 0, y: 7 }],
  "#007AFF": [{ x: 6, y: 7 }, { x: 7, y: 4 }],
  "#34C759": [{ x: 5, y: 6 }, { x: 6, y: 5 }],
  "#FFCC00": [{ x: 4, y: 6 }, { x: 5, y: 5 }],
  "#AF52DE": [{ x: 4, y: 5 }, { x: 5, y: 3 }],
  "#FF9500": [{ x: 4, y: 4 }, { x: 3, y: 3 }],
  "#5AC8FA": [{ x: 6, y: 2 }, { x: 2, y: 5 }]
}
},
{
id: 118,
...
solutions: {
  "#FF3B30": [{ x: 7, y: 6 }, { x: 1, y: 7 }],
  "#007AFF": [{ x: 7, y: 7 }, { x: 6, y: 6 }],
  "#34C759": [{ x: 5, y: 7 }, { x: 6, y: 5 }],
  "#FFCC00": [{ x: 6, y: 3 }, { x: 4, y: 7 }],
  "#AF52DE": [{ x: 6, y: 2 }, { x: 3, y: 7 }],
  "#FF9500": [{ x: 5, y: 2 }, { x: 3, y: 6 }],
  "#5AC8FA": [{ x: 3, y: 4 }, { x: 5, y: 3 }]
}
},
{
id: 119,
...
solutions: {
  "#FF3B30": [{ x: 7, y: 0 }, { x: 7, y: 7 }],
  "#007AFF": [{ x: 4, y: 0 }, { x: 6, y: 1 }],
  "#34C759": [{ x: 1, y: 1 }, { x: 2, y: 3 }],
  "#FFCC00": [{ x: 1, y: 2 }, { x: 3, y: 3 }],
  "#AF52DE": [{ x: 5, y: 1 }, { x: 3, y: 4 }],
  "#FF9500": [{ x: 4, y: 4 }, { x: 2, y: 5 }],
  "#5AC8FA": [{ x: 5, y: 2 }, { x: 1, y: 3 }]
}
},
{
id: 120,
...
solutions: {
  "#FF3B30": [{ x: 6, y: 0 }, { x: 2, y: 1 }],
  "#007AFF": [{ x: 6, y: 1 }, { x: 4, y: 3 }],
  "#34C759": [{ x: 5, y: 2 }, { x: 3, y: 1 }],
  "#FFCC00": [{ x: 4, y: 1 }, { x: 5, y: 6 }],
  "#AF52DE": [{ x: 2, y: 0 }, { x: 3, y: 7 }],
  "#FF9500": [{ x: 2, y: 2 }, { x: 5, y: 5 }]
}
}
